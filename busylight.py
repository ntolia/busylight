...
class Busylight:
    ...
    def __init__(self, zoom_on, govee_api_key, light_name, o365_client_id, o365_secret):
        self.zoom_on = zoom_on
        self.govee_lights = GoveeLights(govee_api_key, light_name)
...
if __name__ == '__main__':
    ...
    busy_light = Busylight(args.zoom_on, args.govee_api_key, args.light_name,
        args.o365_client_id, args.o365_secret_id)
